            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row cn-slider">
                        <div class="col-md-6">
                            <div class="cn-img">
                                <img src="assets/frontend/img/news-350x223-5.jpg" />
                                <div class="cn-title">
                                    <a href="">Lorem ipsum dolor sit</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="cn-img">
                                <img src="assets/frontend/img/news-350x223-4.jpg" />
                                <div class="cn-title">
                                    <a href="">Lorem ipsum dolor sit</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="cn-img">
                                <img src="assets/frontend/img/news-350x223-3.jpg" />
                                <div class="cn-title">
                                    <a href="">Lorem ipsum dolor sit</a>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row cn-slider">
                        <div class="col-md-6">
                            <div class="cn-img">
                                <img src="assets/frontend/img/news-350x223-2.jpg" />
                                <div class="cn-title">
                                    <a href="">Lorem ipsum dolor sit</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="cn-img">
                                <img src="assets/frontend/img/news-350x223-1.jpg" />
                                <div class="cn-title">
                                    <a href="">Lorem ipsum dolor sit</a>
                                </div>
                            </div>
                    ...
                    <div class="tab-content">
                        <div id="popular" class="container tab-pane fade">
                            ...
                            <div class="tn-news">
                                ...
                                <div class="tn-title">
                                    <a href=""> {{ $popular->title}}( {{ $popular->comments_count  }})</a>
                                </div>
                            </div>
                            @endforeach
                        </div>
